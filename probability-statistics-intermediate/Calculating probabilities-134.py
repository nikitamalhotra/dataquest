...
def prob_single_event(p, q, k, N):
    return (p ** k) * (q ** (N - k))

prob_8 = prob_single_event(p, q, 8, 10) * find_outcome_combinations(10, 8)
prob_9 = prob_single_event(p, q, 9, 10) * find_outcome_combinations(10, 9)
prob_10 = prob_single_event(p, q, 10, 10) * find_outcome_combinations(10, 10)