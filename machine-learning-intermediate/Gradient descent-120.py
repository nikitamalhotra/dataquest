...
fig = plt.figure()
ax = fig.gca(projection='3d')
ax.plot_surface(X=theta0s,Y=theta1s,Z=COST)
plt.show()
...
partial0 = partial_cost_theta0(1, 1, x=pga.distance, y=pga.accuracy)
...
gd = gradient_descent(pga.distance, pga.accuracy, alpha=0.01, theta0=0, theta1=0)
costs = gd['costs']
x = list(range(0, len(costs)))
plt.scatter(x, costs)
plt.show()